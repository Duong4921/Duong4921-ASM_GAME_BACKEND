...
{
    /// <inheritdoc />
    public partial class Lab2_AddIdentityAndGameModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkAvatar = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameRoles", x => x.RoleId);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Câu hỏi cơ bản cho người mới bắt đầu", "Dễ" },
                    { 2, "Câu hỏi mức độ trung bình", "Trung bình" },
                    { 3, "Câu hỏi thử thách dành cho chuyên gia", "Khó" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "4", "2 + 2 = ?", 1, "3", "4", "5", "6" },
                    { 2, "Hà Nội", "Thủ đô của Việt Nam là gì?", 1, "Hà Nội", "TP.HCM", "Đà Nẵng", "Huế" },
                    { 3, "C#", "Ngôn ngữ lập trình nào tạo ra .NET?", 2, "Java", "Python", "C#", "Go" },
                    { 4, "Not Found", "HTTP status 404 có nghĩa là gì?", 2, "OK", "Not Found", "Server Error", "Unauthorized" },
                    { 5, "Inversion of Control", "Design pattern nào dùng trong Dependency Injection?", 3, "Singleton", "Factory", "Inversion of Control", "Observer" }
                });
